...
Djaq is available here: <https://github.com/paul-wolf/djaq>. See the readme for more information on installation. 
...
This expression is a string passed as the first argument when creating a DjangoQuery object. In our examples we import under the alias `XQ`:

    from djaq import DjangoQuery as XQ
